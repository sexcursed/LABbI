...
private:
    ...
    // Вспомогательные функции для задания 3
    int get_node_count(Node* p) const;
    bool is_perfectly_balanced_rec(Node* p) const;
...
public:
    ...
    // Задание 3: проверка на идеальную сбалансированность
